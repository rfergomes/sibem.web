                                ...
                                @foreach($igrejas as $igreja)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <small class="d-block text-muted"><span class="bg-light-success text-success rounded p-1 mt-1"> SETOR @if($igreja->cod_setor) {{$igreja->cod_setor}} @else Não informado @endif</span></small>
                                        </td>
                                        <td>
