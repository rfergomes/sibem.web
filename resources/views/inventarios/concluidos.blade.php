                                ...
                                @foreach($inventarios as $inv)
                                    <tr>
                                        <td>
                                            ...
                                            <small class="text-muted d-block fw-bold badge bg-light-primary text-primary"><code>{{ $inv->codigo_unico }}</code>{{ $inv->id_igreja }} @if(isset($inv->igreja->setor)) | Setor: {{ $inv->igreja->setor }} @endif</small>
                                        </td>
                                        <td>
