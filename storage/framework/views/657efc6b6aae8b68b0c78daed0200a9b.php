...
<head>
    ...
    <!-- Favicons -->
    <link href="<?php echo e(asset('landing/assets/img/favicon.png')); ?>" rel="icon">
    <link href="<?php echo e(asset('landing/assets/img/apple-touch-icon.png')); ?>" rel="apple-touch-icon">
    ...
    <!-- Main CSS File -->
    <link href="<?php echo e(asset('landing/assets/css/main.css')); ?>" rel="stylesheet">
...
<body class="index-page">
    ...
    <header id="header" class="header d-flex align-items-center sticky-top">
        <div class="container-fluid container-xl position-relative d-flex align-items-center">
            ...
            <a href="/" class="logo d-flex align-items-center me-auto">
                <img src="<?php echo e(asset('landing/assets/img/logo.png')); ?>" alt="Logo SIBEM" class="img-fluid">
            </a>
            ...
            <nav id="navmenu" class="navmenu">
                <ul>
                    ...
                    <li><a href="<?php echo e(asset('landing/html/Manual_SIBEM.html')); ?>" target="_blank">Documentação</a></li>
                    <li><a href="<?php echo e(route('login')); ?>" class="fw-bold text-primary">Acesse o Sistema</a></li>
                </ul>
                <i class="mobile-nav-toggle d-xl-none bi bi-list"></i>
            </nav>

            <a class="btn-getstarted" href="<?php echo e(asset('landing/suporte/SIBEM_Suporte.exe')); ?>">Suporte Remoto</a>
    ...
    <main class="main">
        ...
        <section id="home" class="hero section">
            ...
            <img src="<?php echo e(asset('landing/assets/img/hero-bg-abstract.jpg')); ?>" alt="" data-aos="fade-in" class="">
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="stats-item text-center w-100 h-100">
                            <span data-purecounter-start="0" data-purecounter-end="<?php echo e($users); ?>"
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="stats-item text-center w-100 h-100">
                            <span data-purecounter-start="0" data-purecounter-end="<?php echo e($regionais); ?>"
                                data-purecounter-duration="1" class="purecounter"></span>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="stats-item text-center w-100 h-100">
                            <span data-purecounter-start="0" data-purecounter-end="<?php echo e($locais); ?>"
                                data-purecounter-duration="1" class="purecounter"></span>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="stats-item text-center w-100 h-100">
                            <span data-purecounter-start="0" data-purecounter-end="<?php echo e($igrejas); ?>"
                                data-purecounter-duration="1" class="purecounter"></span>
                            <p>Casas de Oração</p>
                        </div>
                    </div><!-- End Stats Item -->
            ...
            <div class="container">
                <div class="row gy-4">
                    <div class="col-lg-6 position-relative align-self-start" data-aos="fade-up" data-aos-delay="100">
                        <img src="<?php echo e(asset('landing/assets/img/about.jpg')); ?>" class="img-fluid" alt="">
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-3 col-md-12 footer-links text-center text-md-start">
                    ...
                    <ul>
                        ...
                        <li><i class="bi bi-chevron-right"></i> <a href="<?php echo e(route('login')); ?>">Login</a></li>
                    </ul>
                </div>
            </div>
    ...
    <script src="<?php echo e(asset('landing/assets/vendor/purecounter/purecounter_vanilla.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('landing/assets/vendor/imagesloaded/imagesloaded.pkgd.min.js')); ?>"></script>
